...
//import {LucidiTrash2 } from 'lucide-react'
          ...
          {!loading && allResumes.length===0 &&(
            <div className={styles.emptyStateWrapper}>
              ...
              <p className={styles.emptyText}>
                You haven't created any resumes yet. Start Crafting your professional resume to land your dream job
              </p>
          ...
          {!loading && allResumes.length > 0 &&(
            <div className={styles.grid}>
              ...
              {allResumes.map ((resume)=>(
                <ResumeSummaryCard key={resume._id} imgUrl={resume.thumbnailLink} title={resume.title} createdAt={resume.createdAt} updatedAt={resume.updatedAt} onSelect={()=>navigate(`/resume/${resume._id}`)}

      ...
      ${
        ...
        {thumbnailImg?(
          <div className="relative w-full h-full overflow-hidden">
            ...
            {isSelected && (
              <div className="absolute insert-0 bg-violet-50/10 flex items-center justify-center">
            ...
            {/*hover effect*/}
            <div className="absolute insert-0 bg-gradient-to-t from-violet-100/30 to tansparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            </div>
          </div>
        ):(

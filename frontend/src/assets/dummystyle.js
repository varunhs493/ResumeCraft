export const landingPageStyles = {
  // Main container
  container: "min-h-screen bg-gradient-to-br from-slate-50 via-white to-yellow-50",

  // Header styles
  header: "fixed top-0 w-full z-50 bg-white/70 backdrop-blur-xl border-b border-yellow-100/50",
  ...
  logoIcon: "w-10 h-10 bg-gradient-to-br from-yellow-600 to-fuchsia-600 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-200",
  logoIconInner: "w-5 h-5 text-white",
  logoText: "text-xl sm:text-2xl font-black bg-gradient-to-r from-yellow-600 to-fuchsia-600 bg-clip-text text-transparent",
  mobileMenuButton: "md:hidden p-2 rounded-xl hover:bg-yellow-50 transition-colors",
  mobileMenuIcon: "text-yellow-600",

  // Auth buttons
  desktopAuthButton: "relative group px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-yellow-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl hover:shadow-violet-200",
  desktopAuthButtonText: "relative",
  desktopAuthButtonOverlay: "absolute inset-0 bg-gradient-to-r from-fuchsia-600 to-yellow-600 opacity-0 group-hover:opacity-100 transition-opacity",
  ...
  mobileUserWelcome: "text-yellow-700 font-medium text-center py-2 text-base sm:text-lg",
  mobileDashboardButton: "w-full px-6 py-3 bg-gradient-to-r from-yellow-600 to-fuchsia-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-violet-200/50 transition-all",
  mobileAuthButton: "w-full px-6 py-3 bg-gradient-to-r from-yellow-600 to-fuchsia-600 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-violet-200/50 transition-all",
  // Main content
  main: "pt-24",
  ...
  heroLeft: "space-y-8",
  tagline: "inline-flex items-center gap-2 sm:gap-3 px-4 py-2 bg-gradient-to-r from-yellow-100 to-fuchsia-100 border border-violet-200 text-yellow-700 rounded-full font-bold text-xs sm:text-sm",
  heading: "text-4xl sm:text-6xl lg:text-8xl font-black leading-tight",
  headingText: "block text-slate-900",
  headingGradient: "block bg-gradient-to-r from-yellow-600 via-fuchsia-600 to-amber-500 bg-clip-text text-transparent",
  ...
  // Buttons
  primaryButton: "group relative px-10 py-4 bg-gradient-to-r from-yellow-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
  ...
  heroIllustrationBg: "absolute -inset-8 bg-gradient-to-r from-yellow-200/50 to-fuchsia-200/50 rounded-3xl blur-3xl",
  ...
  featuresTitleGradient: "bg-gradient-to-r from-yellow-600 to-fuchsia-600 bg-clip-text text-transparent",
  ...
  featureCardHover: "absolute -inset-2 bg-gradient-to-r opacity-0 group-hover:opacity-100 transition-opacity blur-xl rounded-3xl from-yellow-200 to-fuchsia-200",
  ...
  // Feature gradients
  featureCardViolet: "from-yellow-50 to-purple-50",
  ...
  ctaCard: "relative",
  ctaCardBg: "absolute -inset-6 sm:-inset-8 bg-gradient-to-r from-yellow-200/50 to-fuchsia-200/50 rounded-3xl blur-3xl",
  ctaCardContent: "relative bg-gradient-to-br from-white to-yellow-50 border border-yellow-100 rounded-3xl p-8 sm:p-16",
  ctaTitle: "text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 mb-4 sm:mb-6",
  ctaTitleGradient: "bg-gradient-to-r from-yellow-600 to-fuchsia-600 bg-clip-text text-transparent",
  ctaDescription: "text-base sm:text-lg text-slate-600 mb-6 sm:mb-10 max-w-2xl mx-auto font-medium",
  ctaButton: "group relative px-8 sm:px-12 py-3 sm:py-5 bg-gradient-to-r from-yellow-600 to-fuchsia-600 text-white font-black text-lg rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
...
export const dashboardStyles = {
  ...
  // Create Button
  createButton: "group relative px-10 py-4 bg-gradient-to-r from-yellow-600 to-fuchsia-600 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:shadow-2xl hover:shadow-violet-200",
  ...
  spinner: "animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-yellow-600",

  // Empty State
  emptyStateWrapper: "flex flex-col items-center justify-center py-12 text-center",
  emptyIconWrapper: "bg-yellow-100 p-4 rounded-full mb-4",
  ...
  // New Resume Card
  newResumeCard: "flex flex-col items-center justify-center bg-gradient-to-br from-yellow-50 to-blue-50 border-2 border-dashed border-yellow-300 rounded-2xl p-6 cursor-pointer transition-all hover:shadow-lg hover:border-yellow-500 h-full",
  newResumeIcon: "w-16 h-16 rounded-full bg-gradient-to-r from-yellow-600 to-fuchsia-600 flex items-center justify-center mb-4",
...
export const cardStyles = {
  ...
  profileInitialsContainer: "w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-yellow-500 to-fuchsia-500 rounded-2xl flex items-center justify-center shadow-md",
  profileInitialsText: "text-base sm:text-lg font-black text-white",
  profileName: "text-xs sm:text-sm font-bold text-gray-800",
  logoutButton: "text-yellow-600 text-[10px] sm:text-xs font-bold cursor-pointer hover:text-fuchsia-600 transition-colors",

  // ResumeSummaryCard styles
  resumeCard: "group relative h-[360px] sm:h-[380px] lg:h-[400px] flex flex-col bg-white border border-gray-200 rounded-3xl overflow-hidden cursor-pointer transition-all duration-500 hover:scale-[1.02] hover:shadow-xl hover:border-yellow-300",
  cardBackground: "absolute inset-0 bg-gradient-to-br from-yellow-100 via-transparent to-fuchsia-100 opacity-0 group-hover:opacity-100 transition-opacity duration-500",
  ...
  title: "text-sm sm:text-base font-bold text-gray-800 truncate mb-2 group-hover:text-yellow-600 transition-colors",
...
export const authStyles = {
  container: "w-[90vw] md:w-[400px] p-8 bg-gradient-to-br from-white to-yellow-50 rounded-3xl border border-yellow-100 shadow-2xl",
  ...
  submitButton: "w-full py-4 bg-gradient-to-r from-yellow-600 to-fuchsia-600 text-white font-black rounded-2xl hover:scale-105 hover:shadow-xl hover:shadow-yellow-200 transition-all text-lg",
...
export const additionalInfoStyles = {
  ...
  languageItem: "relative bg-white border border-yellow-100 p-6 rounded-2xl shadow-sm hover:shadow-lg transition-all",
  interestItem: "relative",
  addButtonLanguage: "bg-gradient-to-r from-yellow-500 to-fuchsia-500",
...
export const containerStyles = {
  ...
  header: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-gradient-to-r from-white to-yellow-50 border border-violet-100 rounded-2xl py-4 px-6 mb-6 shadow-sm",
  ...
  previewContainer: "bg-white border border-yellow-100 rounded-2xl overflow-hidden shadow-sm p-4",
...
export const buttonStyles = {
  theme: "flex items-center gap-2 px-3 sm:px-4 py-2 bg-violet-100 text-yellow-700 font-bold rounded-xl hover:bg-violet-200 transition-all",
  ...
  next: "flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-yellow-500 to-fuchsia-500 text-white font-bold rounded-xl hover:scale-105 transition-all shadow-lg text-sm",
...
export const statusStyles = {
  ...
  modalBadge: "inline-flex items-center gap-2 bg-yellow-100 px-3 py-1 rounded-full text-sm font-medium text-yellow-700",
...
export const inputStyles = {
  wrapper: "mb-6 group",
  label: "block text-sm font-bold text-gray-800 mb-3 group-focus-within:text-yellow-600 transition-colors",
  inputContainer: focused => `relative flex items-center bg-gray-50 border-2 px-4 py-3 rounded-xl transition-all duration-300 ${focused
    ? 'border-yellow-500 ring-4 ring-violet-500/20 shadow-lg shadow-yellow-500/10'
    : 'border-gray-300 hover:border-gray-400'}`,
  inputField: "w-full bg-transparent outline-none text-gray-800 placeholder-gray-500 font-medium",
  toggleButton: "text-gray-500 hover:text-yellow-600 transition-colors p-1 rounded-lg hover:bg-gray-100",
};

export const photoSelectorStyles = {
  container: "flex justify-center mb-8",
  hiddenInput: "hidden",
  placeholder: hovered => `relative w-32 h-32 sm:w-36 sm:h-36 flex items-center justify-center bg-gray-50 border-2 border-dashed border-gray-300 rounded-full cursor-pointer transition-all duration-300 ${hovered ? 'hover:border-yellow-500 hover:bg-yellow-50' : ''}`,
  cameraButton: "absolute -bottom-2 -right-2 w-12 h-12 flex items-center justify-center bg-gradient-to-r from-yellow-500 to-fuchsia-500 hover:from-yellow-600 hover:to-fuchsia-600 text-white rounded-full transition-all shadow-lg hover:scale-110",
  previewWrapper: "relative group",
  previewImageContainer: hovered => `w-32 h-32 sm:w-36 sm:h-36 rounded-full overflow-hidden border-4 border-gray-200 shadow-lg transition-all duration-300 ${hovered ? 'group-hover:border-yellow-400' : ''}`,
...
export const titleInputStyles = {
  ...
  editIcon: "w-5 h-5 text-gray-600 group-hover:text-yellow-600 transition-colors",
  ...
  confirmButton: "p-2 rounded-xl bg-violet-500 hover:bg-yellow-600 text-white transition-all",
};

export const modalStyles = {
  overlay: "fixed inset-0 flex items-center justify-center w-full h-full bg-black/60 backdrop-blur-sm z-50",
  container: "relative flex flex-col bg-white/95 backdrop-blur-xl shadow-2xl rounded-3xl overflow-hidden border border-yellow-100 max-w-[95vw] max-h-[95vh]",
  header: "flex items-center justify-between p-6 border-b border-yellow-100 bg-gradient-to-r from-white to-yellow-50",
  title: "text-xl font-black text-slate-900",
  actionButton: "flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-yellow-500 to-fuchsia-500 text-white font-bold rounded-xl hover:scale-105 transition-all shadow-lg mr-12",
